    ...
    <MainLayout height='h-[92%]'>
      <>
        ...
        <div className='h-full flex flex-col gap-4 justify-center md:px-[100px]'>
            <Input value={username} onChange={(e)=>setUsername(e.target.value)} id="username-input" className='p-2 md:p-4' bg='bg-[#313A56]' placeholder='یوزرنیم خود را وارد کنید' />
            <Input value={email} onChange={(e)=>setEmail(e.target.value)} className='p-2 md:p-4' id='email-input' bg='bg-[#313A56]' placeholder='ایمیل خود را وارد کنید' />
